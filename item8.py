...
def stem_stad(stad='Amsterdam'):
    """
    Deze functie returnt een dataframe waarin het aantal stemmen per partij vd grootste 3 partijen van hoog naar laag staan in een meegegeven gemeente. Amsterdam is default.
    """
...
def zetels_per_3_grootste_partijen(stad='Amsterdam'):
    ...
    """
    data = stem_stad(stad)  # hier wordt de df van 3 grootste partijen ingeladen
